...
public class VideoController {
	...
	public @ResponseBody VideoStatus setVideoData( @PathVariable("id") long id, @RequestParam("data") MultipartFile videoData, HttpServletResponse response){
		...
		else
		{
			try {
					...
					vfm.saveVideoData(currVideo, videoData.getInputStream());
	...
	public void getVideoData( @PathVariable("id") long id, HttpServletResponse response){
		...
		{
			try {
				VideoFileManager.get().copyVideoData(currVideo, response.getOutputStream());
			} catch (IOException e) {
				response.setStatus(HttpServletResponse.SC_NOT_FOUND);
			}
		}
